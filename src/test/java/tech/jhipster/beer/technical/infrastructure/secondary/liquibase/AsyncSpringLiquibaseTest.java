package tech.jhipster.beer.technical.infrastructure.secondary.liquibase;
...
import tech.jhipster.beer.LogbackRecorder;
import tech.jhipster.beer.LogbackRecorder.Event;
...
class AsyncSpringLiquibaseTest {
  ...
  @Test
  void shouldInitDbWithFastProfile() {
    environment.setActiveProfiles("fast");
